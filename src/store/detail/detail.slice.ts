...
const detailSlice = createSlice({
    ...
    reducers: {
        ...
        loadSuccess: (state, action) => {
            ...
            state.price_per_connect = action.payload.company.price_per_connect;
            state.initial_time = action.payload.company.initial_time;
            state.price_per_minutes_overdue =
                action.payload.company.price_per_minutes_overdue;
            state.overdue_time = action.payload.company.overdue_time;
            state.company_fields = action.payload.company.company_fields;
            state.phone = action.payload.company.phone;
            state.message = "";
            state.errors = null;
            state.loading = false;
        },
